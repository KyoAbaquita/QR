...
// Priority 1: MYSQL_URL / MYSQL_PUBLIC_URL (Single Link)
// Priority 2: Individual variables (MYSQLHOST, MYSQLUSER, etc.)
const poolConfig = (process.env.MYSQL_URL || process.env.MYSQL_PUBLIC_URL) ? {
    ...
    ssl: (process.env.MYSQLHOST || process.env.DB_HOST) ? { rejectUnauthorized: false } : null,
};
